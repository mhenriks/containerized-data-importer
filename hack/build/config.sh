...
BINARIES="cmd/${CONTROLLER} cmd/${IMPORTER} cmd/${APISERVER} tools/${FUNC_TEST_INIT}"
...
DOCKER_IMAGES="cmd/${CONTROLLER} cmd/${IMPORTER} cmd/${CLONER} cmd/${APISERVER} tools/${FUNC_TEST_INIT} tools/${FUNC_TEST_HTTP}"
