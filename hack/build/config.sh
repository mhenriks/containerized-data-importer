...
BINARIES="cmd/${CONTROLLER} cmd/${IMPORTER} cmd/${APISERVER} cmd/${UPLOADPROXY} tools/${FUNC_TEST_INIT}"
...
DOCKER_IMAGES="cmd/${CONTROLLER} cmd/${IMPORTER} cmd/${CLONER} cmd/${APISERVER} cmd/${UPLOADPROXY} tools/${FUNC_TEST_INIT} tools/${FUNC_TEST_HTTP}"
